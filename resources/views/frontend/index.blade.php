				...
				@if(isset($contentDetails['banner']) && $bannerContents = $contentDetails['banner'])
					@foreach($bannerContents as $bannerContent)
						<div class="hero-item">
							...
							<div class="hero-img">
								<img
									src="{{ getFile(config('location.content.path').(isset($bannerContent->content->contentMedia->description->image) ? $bannerContent->content->contentMedia->description->image : '')) }}"
						...
						@if(isset($contentDetails['services']) && $serviceContents = $contentDetails['services'])
							@foreach($serviceContents as $serviceContent)
								<div class="get-payment-item bg--body">
									<div class="img">
										<img
											src="{{ getFile(config('location.content.path').(isset($serviceContent->content->contentMedia->description->image) ? $serviceContent->content->contentMedia->description->image : '')) }}">
									</div>
									<div class="cont">
