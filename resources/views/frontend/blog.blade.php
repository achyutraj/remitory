							...
							<div class="post-inner">
								<div class="post-img">
									<a href="{{ route('blogDetails', $blogContent) }}">
										<img src="{{ getFile(config('location.content.path').(isset($blogContent->content->contentMedia->description->image) ? optional(optional(optional($blogContent->content)->contentMedia)->description)->image : '')) }}" alt="@lang('Blog-image')">
									</a>
								</div>
