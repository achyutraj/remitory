										...
										<div class="form-group search-currency-dropdown">
											...
											<select id="currency" name="currency"
												...
												<option value="{{ $requestMoney->currency->id }}"
														data-currency="{{ __($requestMoney->currency->code) }}"
														data-currencytype="{{ $requestMoney->currency->currency_type }}"
														{{ ($requestMoney->currency_id == $requestMoney->currency->id) ? 'selected' : '' }}>
													{{ __($requestMoney->currency->code) }} - {{ __($requestMoney->currency->name) }}
												</option>
											</select>
											<div class="invalid-feedback">
