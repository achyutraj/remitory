                ...
                <div class="col-lg-6 col-xl-5 col-xxl-4">
                    <div class="section__title text--white text-center text-lg-start">
                        ...
                        <a href="{{ @$template->templateMedia()->description->button_link }}" class="cmn--btn btn-outline btn-sm mt-3"><i class="las la-angle-left"></i>
                            @lang(@$template->description->button_name)
						</a>
                    </div>
                </div>
				@endif
                    ...
                    <div class="account__wrapper bg--body">
						...
						@if (session('status'))
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								...
								<button type="button" class="btn-close removeStatus" data-bs-dismiss="alert" aria-label="Close">
								</button>
							</div>
						@endif
                        ...
                        <form class="account-form" action="{{ route('login') }}" method="post">
                            ...
                            <div class="form--group">
                                <input type="text" name="identity" value="{{ old('identity') }}" class="form-control form--control @error('username') is-invalid @enderror @error('email') is-invalid @enderror" id="username">
                                <label for="identity" class="form--label prevent-select">@lang('Username or Email')</label>
                            ...
                            <div class="form--group checkgroup d-flex flex-row justify-content-between">
								...
								<div>
									...
									<a href="{{ route('password.request') }}" class="text--base">@lang('Forgot Your Password')?</a>
									@endif
								</div>
                            </div>
                            ...
                            <div class="form--group mb-0 text-center">
                                @lang("Don't have an account?") <a href="{{ route('register') }}" class="text--base">@lang('Sign Up')</a>
                            </div>
                        </form>
                    </div>
                </div>
